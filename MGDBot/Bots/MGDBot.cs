...
namespace MGDBot.Bots
{
    /// <summary>
    /// http://rtd.discord.foxbot.me/en/legacy/getting_started.html
    /// Invite BOT: https://discordapp.com/oauth2/authorize?client_id=CLIENTID&scope=bot&permissions=66186303
    ...
    public class MGDBot
    {
        ...
        protected virtual async Task Initialize()
        {
            ...
            serviceMap.AddSingleton(new MeetUpBroadcastService());
        ...
        private async Task HandleCommandAsync(SocketMessage arg)
        {
            ...
            if (msg.HasCharPrefix('!', ref pos) /* || msg.HasMentionPrefix(_client.CurrentUser, ref pos) */)
            {
                ...
                if (result.IsSuccess)
                {
                    await context.Channel.DeleteMessagesAsync(new List<IMessage>(){ context.Message});
